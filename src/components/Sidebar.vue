    ...
    <div class="pt-32 ">
        <div class="pb-9">
            <div class="flex flex-col gap-3  px-10">
                <a href="#/home" class="flex gap-3 text-gray-500">
        ...
        <div class="p-5 relative">
            <div class="flex justify-between"><span class="text-sm">MY PROJECTS</span>
                <div v-on:click="toogleModalCreate()" class="cursor-pointer hover:scale-125 "><svg xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <a href="/" class="w-full flex gap-2 flex-col">
